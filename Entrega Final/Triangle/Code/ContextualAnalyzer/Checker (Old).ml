...
(**
Report an undeclared identifier error
...
(**
Report an undeclared operator error
...
@param id  string, string, name of the identifier
@return string
*)
...
@param ft ast_field_type_denoter, the field to search
@param id  string, string, name of the identifier
@return string
*)
...
(**
  ...
  @param a AST syntactic tree
  @return AST, decorated tree
*)
