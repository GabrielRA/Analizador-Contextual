...
let falseDecl  = Const_declaration({pos=Lexing.dummy_pos;run=NullRuntimeEntity}, Identifier({pos=Lexing.dummy_pos;run=NullRuntimeEntity}, "false"), Checked_expression(EmptyExpression({pos=Lexing.dummy_pos;run=NullRuntimeEntity}), booleanType))
let trueDecl   = Const_declaration({pos=Lexing.dummy_pos;run=NullRuntimeEntity}, Identifier({pos=Lexing.dummy_pos;run=NullRuntimeEntity}, "true"), Checked_expression(EmptyExpression({pos=Lexing.dummy_pos;run=NullRuntimeEntity}), booleanType))
let maxintDecl = Const_declaration({pos=Lexing.dummy_pos;run=NullRuntimeEntity}, Identifier({pos=Lexing.dummy_pos;run=NullRuntimeEntity}, "maxint"), Checked_expression(EmptyExpression({pos=Lexing.dummy_pos;run=NullRuntimeEntity}), integerType))
...
let eolDecl = Func_declaration({pos=Lexing.dummy_pos;run=NullRuntimeEntity}, Identifier({pos=Lexing.dummy_pos;run=NullRuntimeEntity}, "eol"), Empty_formal_parameter_sequence({pos=Lexing.dummy_pos;run=NullRuntimeEntity}), booleanType, EmptyExpression({pos=Lexing.dummy_pos;run=NullRuntimeEntity}))
let eofDecl = Func_declaration({pos=Lexing.dummy_pos;run=NullRuntimeEntity}, Identifier({pos=Lexing.dummy_pos;run=NullRuntimeEntity}, "eof"), Empty_formal_parameter_sequence({pos=Lexing.dummy_pos;run=NullRuntimeEntity}), booleanType, EmptyExpression({pos=Lexing.dummy_pos;run=NullRuntimeEntity}))
