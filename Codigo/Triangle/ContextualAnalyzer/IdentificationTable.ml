...
let boolean_decl = 
  Type_declaration({pos=Lexing.dummy_pos;run=Null_runtime_entity},
    Identifier({pos=Lexing.dummy_pos;run=Null_runtime_entity}, "Boolean"), boolean_type
  )
  
let char_decl = 
  Type_declaration({pos=Lexing.dummy_pos;run=Null_runtime_entity}, 
    Identifier({pos=Lexing.dummy_pos;run=Null_runtime_entity}, "Char"), char_type
  )

let integer_decl = 
  Type_declaration({pos=Lexing.dummy_pos;run=Null_runtime_entity},
    Identifier({pos=Lexing.dummy_pos;run=Null_runtime_entity}, "Integer"), integer_type
  )

let false_decl = 
  Const_declaration({pos=Lexing.dummy_pos;run=Null_runtime_entity}, 
    Identifier({pos=Lexing.dummy_pos;run=Null_runtime_entity}, "false"),
	  Checked_expression(Empty_expression({pos=Lexing.dummy_pos;run=Null_runtime_entity}), boolean_type)
  )
...
let maxint_decl = 
  Const_declaration({pos=Lexing.dummy_pos;run=Null_runtime_entity}, 
    ...
    Checked_expression(Empty_expression({pos=Lexing.dummy_pos;run=Null_runtime_entity}), integer_type)
  )

let not_decl = 
  Unary_operator_declaration({pos=Lexing.dummy_pos;run=Null_runtime_entity},
    Operator({pos=Lexing.dummy_pos;run=Null_runtime_entity}, "\\"), boolean_type, boolean_type
  )

let and_decl = 
  Binary_operator_declaration({pos=Lexing.dummy_pos;run=Null_runtime_entity},
...
let get_decl = 
  Proc_declaration({pos=Lexing.dummy_pos;run=Null_runtime_entity}, 
    Identifier({pos=Lexing.dummy_pos;run=Null_runtime_entity}, "get"), 
  	...
  	Var_formal_parameter({pos=Lexing.dummy_pos;run=Null_runtime_entity},
  	Identifier({pos=Lexing.dummy_pos;run=Null_runtime_entity}, ""), char_type)),
...
let put_decl = 
  Proc_declaration({pos=Lexing.dummy_pos;run=Null_runtime_entity}, 
    Identifier({pos=Lexing.dummy_pos;run=Null_runtime_entity}, "put"), 
  	Single_formal_parameter_sequence({pos=Lexing.dummy_pos;run=Null_runtime_entity}, 
  	Const_formal_parameter({pos=Lexing.dummy_pos;run=Null_runtime_entity}, 
  	Identifier({pos=Lexing.dummy_pos;run=Null_runtime_entity}, ""), char_type)), 
  	Empty_command({pos=Lexing.dummy_pos;run=Null_runtime_entity})
  )
...
let getint_decl = 
  Proc_declaration({pos=Lexing.dummy_pos;run=Null_runtime_entity}, 
    Identifier({pos=Lexing.dummy_pos;run=Null_runtime_entity}, "getint"), 
  	Single_formal_parameter_sequence({pos=Lexing.dummy_pos;run=Null_runtime_entity},
  	Var_formal_parameter({pos=Lexing.dummy_pos;run=Null_runtime_entity}, 
  	Identifier({pos=Lexing.dummy_pos;run=Null_runtime_entity}, ""), integer_type)),
  	Empty_command({pos=Lexing.dummy_pos;run=Null_runtime_entity})
  )
...
let geteol_decl = 
  Proc_declaration({pos=Lexing.dummy_pos;run=Null_runtime_entity}, 
    Identifier({pos=Lexing.dummy_pos;run=Null_runtime_entity}, "geteol"),
  	Empty_formal_parameter_sequence({pos=Lexing.dummy_pos;run=Null_runtime_entity}), 
  	Empty_command({pos=Lexing.dummy_pos;run=Null_runtime_entity})
  )
...
let chr_decl = 
  Func_declaration({pos=Lexing.dummy_pos;run=Null_runtime_entity}, 
    Identifier({pos=Lexing.dummy_pos;run=Null_runtime_entity}, "chr"), 
    Single_formal_parameter_sequence({pos=Lexing.dummy_pos;run=Null_runtime_entity}, 
    Const_formal_parameter({pos=Lexing.dummy_pos;run=Null_runtime_entity}, 
    Identifier({pos=Lexing.dummy_pos;run=Null_runtime_entity}, ""), integer_type)), char_type,
...
let ord_decl = 
  Func_declaration({pos=Lexing.dummy_pos;run=Null_runtime_entity}, 
    Identifier({pos=Lexing.dummy_pos;run=Null_runtime_entity}, "ord"), 
  	Single_formal_parameter_sequence({pos=Lexing.dummy_pos;run=Null_runtime_entity}, 
  	Const_formal_parameter({pos=Lexing.dummy_pos;run=Null_runtime_entity}, 
  	Identifier({pos=Lexing.dummy_pos;run=Null_runtime_entity}, ""), char_type)), integer_type, 
  	Empty_expression({pos=Lexing.dummy_pos;run=Null_runtime_entity})
  )
...
let eol_decl = 
  Func_declaration({pos=Lexing.dummy_pos;run=Null_runtime_entity}, 
    Identifier({pos=Lexing.dummy_pos;run=Null_runtime_entity}, "eol"), 
  	Empty_formal_parameter_sequence({pos=Lexing.dummy_pos;run=Null_runtime_entity}), boolean_type, 
  	Empty_expression({pos=Lexing.dummy_pos;run=Null_runtime_entity})
  )
